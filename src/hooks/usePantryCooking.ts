...
const VEGETABLE_KEYWORDS = [
  ...
  '苦瓜', '黄瓜', '丝瓜', '冬瓜', '南瓜', '番茄', '西红柿', '洋葱', '白菜', '菠菜', '生菜', '油菜', '芹菜', '西芹', '韭菜', '豆角', '茄子', '青椒', '辣椒', '胡萝卜', '白萝卜', '萝卜', '蘑菇', '香菇', '木耳', '豆腐', '豆芽', '菜花', '西兰花', '香菜', '蒜苗', '空心菜', '秋葵', '芦笋', '莴笋', '蒜薹', '蒜苔', '腐竹', '娃娃菜', '圆白菜', '包菜', '荠菜', '豆苗', '茼蒿', '苋菜', '莴苣', '荷兰豆', '油麦菜', '西葫芦', '包心菜', '西洋菜', '皇帝菜', '地瓜叶', '红薯叶', '蓬蒿',
  // 蔬菜泛称
  '菜心', '菜叶', '瓜', '茄', '葱', '蒜', '姜', '笋', '菌', '菇', '藻', '芹', '辣',
];
